/* Generated by gliss-attr (112/01/08 16:19:37) copyright (c) 2009 IRIT - UPS */
...
static void otawa_sem_LDRSSH_S___LT_SS_S_IDSS(arm_inst_t *inst, otawa::sem::Block& block) {
;
};
...
static void otawa_sem_LDRSSB_S___LT_SS_S_IDSS(arm_inst_t *inst, otawa::sem::Block& block) {
;
};
...
static void otawa_sem_LDRSH_S___LT_SS_S_IDSS(arm_inst_t *inst, otawa::sem::Block& block) {
;
};
...
static void otawa_sem_STRSH_S___LT_SS_S_IDSS(arm_inst_t *inst, otawa::sem::Block& block) {
;
};
...
static void otawa_sem_TSTS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_TSTS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_TSTS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_TSTS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_TSTS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
			...
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_TSTS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_TSTS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_TSTS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_TEQS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_TEQS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_TEQS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_TEQS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_TEQS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_TEQS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_TEQS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_TEQS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_SUBSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_SUBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_SBCSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_SBCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_RSCSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_RSCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_RSBSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_RSBSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_ORRSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_ORRSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_MVNSS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_MVNSS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_MVNSS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_MVNSS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_MVNSS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_MVNSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_MVNSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_MVNSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_MOVSS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_MOVSS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_MOVSS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_MOVSS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_MOVSS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_MOVSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_MOVSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_MOVSS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_EORSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_EORSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_EORSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_CMPS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_CMPS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_CMPS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_CMPS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_CMPS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_CMPS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_CMPS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_CMPS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_CMNS_S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_CMNS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_CMNS_S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_CMNS_S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_CMNS_S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_CMNS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_CMNS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_CMNS_S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_BICSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_BICSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_BICSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_ANDSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_ANDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
...
static void otawa_sem_ADDSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_ADDSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
	block.add(sem::add(_GPR(ARM_ADDSS_S__S__S__S__ID_x_rd_r), _GPR(ARM_ADDSS_S__S__S__S__ID_x_rn_r), -1));
	if(ARM_ADDSS_S__S__S__S__ID_x_sets_set) {
		block.add(sem::seti(-1, 0));
		block.add(sem::cmp(_CPSR(), _GPR(ARM_ADDSS_S__S__S__S__ID_x_rd_r), -1));
	}
...
static void otawa_sem_ADCSS_S__S__S__S__ID(arm_inst_t *inst, otawa::sem::Block& block) {
	if((((uint32_t)(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
		block.add(sem::seti(-1, ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt));
	else {
		switch(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_shiftKind) {
		case 3:
			block.add(sem::scratch(-1));
			if((((uint32_t)(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_shiftAmt)) == 0))
				block.add(sem::scratch(_CPSR()));
			break;
		case 2:
			block.add(sem::asr(-1, _GPR(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 1:
			block.add(sem::shr(-1, _GPR(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		case 0:
			block.add(sem::shl(-1, _GPR(ARM_ADCSS_S__S__S__S__ID_x_shifter_operand_r_r), -1));
			break;
		}
	}
	block.add(sem::scratch(_GPR(ARM_ADCSS_S__S__S__S__ID_x_rd_r)));
	if(ARM_ADCSS_S__S__S__S__ID_x_sets_set)
		block.add(sem::scratch(_CPSR()));
...
static sem_fun_t sem_funs[] = {
	...
	otawa_sem_LDRSSH_S___LT_SS_S_IDSS,
	otawa_sem_LDRSSB_S___LT_SS_SSSS,
	otawa_sem_LDRSSB_S___LT_SS_S_IDSS,
	otawa_sem_LDRSH_S___LT_SS_SSSS,
	otawa_sem_LDRSH_S___LT_SS_S_IDSS,
	otawa_sem_STRSH_S___LT_SS_SSSS,
	otawa_sem_STRSH_S___LT_SS_S_IDSS,
