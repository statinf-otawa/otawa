...
namespace otawa { namespace aarch64 {
 ...
 * @li @ref otawa::Inst
 */
Identifier<bool> IS_MLA("otawa::aarch64::IS_MLA", false);
...
Identifier<int> NUM_REGS_LOAD_STORE("otawa::aarch64::NUM_REGS_LOAD_STORE", 1);
 ...
 * @li @ref otawa::Inst
 */
Identifier <bool> IS_SP_RELATIVE("otawa::aarch64::IS_SP_RELATIVE", false);
 ...
 * @li @ref otawa::Inst
 */
Identifier <bool> IS_PC_RELATIVE("otawa::aarch64::IS_PC_RELATIVE", false);
