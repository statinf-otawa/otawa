#include <otawa/oslice_reg/LivenessChecker.h>
#include <otawa/util/Bag.h>
#include <elm/util/Pair.h>

namespace otawa { namespace oslice_reg {
//static Identifier<otawa::oslice_reg::clp_value_set_t* > MEM_BB_END_IN("", NULL);
static Identifier<dfa::MemorySet::t* > MEM_BB_END_IN("", NULL);
//static Identifier<otawa::oslice_reg::clp_value_set_t* > MEM_BB_BEGIN_OUT("", NULL);
...
extern Identifier<otawa::oslice_reg::BBSet*> SetOfCallers;
