...
IF(BISON_EXECUTABLE)
 MACRO(BISON_FILE FILENAME)
   ...
   SET(OUTFILE "${CMAKE_CURRENT_BINARY_DIR}${PATH_OPT}/${HEAD}.c")
   IF(BISON_GENERATE_DEFINES)
     SET(HEADER "${CMAKE_CURRENT_BINARY_DIR}${PATH_OPT}/${HEAD}.h")
     ADD_CUSTOM_COMMAND(
     ...
     SET_SOURCE_FILES_PROPERTIES("${OUTFILE}" "${HEADER}" PROPERTIES LANGUAGE CXX GENERATED TRUE)
   ...
   ELSE(BISON_GENERATE_DEFINES)
     ADD_CUSTOM_COMMAND(
       ...
       "${CMAKE_CURRENT_SOURCE_DIR}/${FILENAME}"
       DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/${FILENAME}")
     SET_SOURCE_FILES_PROPERTIES("${OUTFILE}" PROPERTIES LANGUAGE CXX GENERATED TRUE)
