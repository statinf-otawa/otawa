...
function(OTAWA_FIND)
	if(NOT OTAWA_CONFIG)
		...
		if (EXISTS "${OTAWA_CONFIG}")
			message(STATUS "using otawa-config given at ${OTAWA_CONFIG}")
		else()
			message(FATAL_ERROR "otawa-config not found at the given path : ${OTAWA_CONFIG}")
		endif()
	endif()
endfunction()
