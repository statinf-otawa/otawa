/*
 *     $Id$
 *     The common header file for otawa::oslice_reg
 *
...
}} // end of otawa::oslice_reg

namespace elm {
template<>
class Comparator<otawa::oslice_reg::InterestedInstruction*> {
public:
	inline static int compare(otawa::oslice_reg::InterestedInstruction* const & a, otawa::oslice_reg::InterestedInstruction* const & b) {
