...
protected:
	...
	virtual void onNoBlock(Address address, bool ignore_seq);
...
private:
	...
	void scanForceCall(xom::Element *element, ContextualPath& cpath);
	void scanForceBranch(xom::Element *element, ContextualPath& cpath);
